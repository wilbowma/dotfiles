...
values."
  (setq-default
   ...
   '(
     ...
     version-control
     ;(elfeed :variables
     ;        elfeed-db-directory "~/webdav/elfeed"
     ;        rmh-elfeed-org-files (list "~/workspace/org/feeds.org"))
     )
...
you should place your code here."
  ...
  ;; order matters to getting checkers right; I want langtool before textidote
